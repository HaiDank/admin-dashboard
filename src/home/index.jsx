  ...
  return (
    <section>
      <div className='text-green-50 bg-homepage h-[45rem] bg-cover bg-no-repeat flex flex-col items-center justify-center space-y-14'>
        ...
        <button className='text-xl font-bold px-16 py-2 bg-green-accent rounded text-green-100 border-2 border-green-variant hover:border-green-200 hover:text-white'
