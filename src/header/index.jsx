  ...
  return (
    <section className='mb-18 flex'>
      <div className='fixed flex top-0 border-b-2 shadow-md w-full bg-teal-50 h-18 z-20 px-8 justify-between'>
        ...
        <div className='flex text-lg space-x-4 px-4 items-center font-semibold'>
          <button className='border-2 px-8 py-1 border-green-variant text-green-accent hover:bg-green-100 rounded-full'>Register</button>
          <button className='border-2 px-8 py-1 bg-green-accent border-green-variant text-whitegray hover:opacity-90 rounded-full'>Login</button>
        </div>
      </div >
    </section >
  )
